...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 class="font-weight-bold m-0">
            User Profile
            <small class="text-muted font-size-sm ml-2" id="drawer_messages_count"> 0 messages</small>
        </h3>
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url('{{asset('assets/images/'.Auth::guard('admin')->user()->image )}}')"></div>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="navi mt-2">
                    <a href="{{ route('adminLogout') }}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
                </div>
            </div>
        </div>
        <!--end::Header-->
      ...
      <!--  <a href="custom/apps/user/profile-1/personal-information.html" class="navi-item"> -->
            <a href="{{ route('admin_profile') }}" class="navi-item">
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        ...
                        <div class="text-muted">
                            ...
                            <span class="label label-light-danger label-inline font-weight-bold">Soon</span>
                        </div>
                    </div>
                </div>
            </a>
