            ...
            <div class="login-aside d-flex flex-column flex-row-auto">
                ...
                <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                    ...
                    <a href="#" class="login-logo text-center pt-lg-25 pb-10">
                        <img src="{{asset('assets/media/logos/dept-logo.jpg')}}" class="max-h-70px" alt="" />
                    ...
                    <h3 class="font-weight-bolder text-center font-size-h4 text-dark-50 line-height-xl">
                        Keywords Analytic System (KAS)<br />
                        Social Media Dept.
                    </h3>
                    <!--end::Aside Title-->
                </div>
                ...
                <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center"
                    style="background-image: url({{asset('assets/media/logos/social-media-small.jpg')}})">
                </div>
                <!--end::Aside Bottom-->
            </div>
            <!--begin::Aside-->
            ...
            <div class="login-content flex-row-fluid d-flex flex-column p-10">
                ...
                <div class="d-flex flex-row-fluid flex-center">
                    <div class="login-form">
                        <form class="form" id="kt_login_singin_form" action="{{ route('adminLoginPost') }}" method="POST">
                            {!! csrf_field() !!}
                            ...
                            <div class="pb-lg-0 pb-5">
                                ...
                                <button type="button" class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg">
                                    <span class="svg-icon svg-icon-md">
                                        <!--begin::Svg Icon | path:media/svg/social-icons/google.svg--><svg
