...
@section('content')
    ...
    <div class="card card-custom container mt-5">
        <div class="card">
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="text-right"><a href="#" onclick="showModal({{ $user->id }})"
                                            class="btn btn-light-primary font-weight-bolder btn-sm">details</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
    ...
    <script>
        ...
        function fillContent(data) {
            ...
            for (var i in list) {
                ...
                html += '   <td>';
                html += '    <a href="'+ postUrl+'/'+list[i].s_id+'" class="coltext-dark-75 mt-3 font-weight-bolder text-hover-primary font-size-lg">';
            ...
            html_user +='<a href="'+base_url+'admin/view_user/'+user.id+'" class="coltext-dark-75 mt-3 font-weight-bolder text-hover-primary font-size-lg">' + user.name + '</a>';
